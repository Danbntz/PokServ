...
am__theforgottenserver_SOURCES_DIST = account.h actions.cpp actions.h \
	...
	combat.h duel.cpp duel.h condition.cpp condition.h config.h \
	...
	ioban.cpp ioban.h iomarket.cpp iomarket.h ioguild.cpp \
	ioguild.h iologindata.cpp iologindata.h iomap.cpp \
	...
	md5.cpp md5.h monster.cpp monster.h monsters.cpp monsters.h \
	movement.cpp movement.h networkmessage.cpp networkmessage.h \
	npc.cpp npc.h otpch.h otserv.cpp otsystem.h outfit.cpp \
	outfit.h pokeaddon.cpp pokeaddon.h outputmessage.cpp \
...
am_theforgottenserver_OBJECTS = actions.$(OBJEXT) $(am__objects_1) \
	...
	chat.$(OBJEXT) combat.$(OBJEXT) duel.$(OBJEXT) \
	...
	inputbox.$(OBJEXT) ioban.$(OBJEXT) iomarket.$(OBJEXT) \
...
ACLOCAL = ${SHELL} /otserv/source/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /otserv/source/missing autoconf
AUTOHEADER = ${SHELL} /otserv/source/missing autoheader
AUTOMAKE = ${SHELL} /otserv/source/missing automake-1.14
AWK = mawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LUA_LIBS = -llua5.1 
MAKEINFO = ${SHELL} /otserv/source/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
ODBC_FLAGS = 
ODBC_LIBS = 
OPTIONAL_FLAGS =  -D__ENABLE_SERVER_DIAGNOSTIC__ -D__EMERGENCY_SAVE__ -D__ROOT_PERMISSION__
...
XML_LIBS = -lxml2
abs_builddir = /otserv/source
abs_srcdir = /otserv/source
abs_top_builddir = /otserv/source
abs_top_srcdir = /otserv/source
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /otserv/source/install-sh
...
theforgottenserver_SOURCES = account.h actions.cpp actions.h $(MAYBE_REMOTE) \
	...
	beds.h chat.cpp chat.h combat.cpp combat.h duel.cpp duel.h condition.cpp condition.h \
	...
	iomarket.cpp iomarket.h ioguild.cpp ioguild.h iologindata.cpp iologindata.h iomap.cpp \
	...
	otserv.cpp otsystem.h outfit.cpp outfit.h pokeaddon.cpp pokeaddon.h outputmessage.cpp \
	outputmessage.h party.cpp party.h playerbox.cpp playerbox.h \
